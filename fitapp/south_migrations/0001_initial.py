...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserFitbit'
        db.create_table('fitapp_userfitbit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm[user_orm_label], unique=True)),
            ('fitbit_user', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('auth_token', self.gf('django.db.models.fields.TextField')()),
            ('auth_secret', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('fitapp', ['UserFitbit'])


    def backwards(self, orm):
        # Deleting model 'UserFitbit'
        db.delete_table('fitapp_userfitbit')
